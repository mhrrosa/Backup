...
def gerarRelatorio(file_name_turma_disciplina,file_name_asc_xml,file_json_sigla,file_name_capacidade,file_json_turmasfic,contador):
    ...
    #criando dict para trazer a capacidade das salas
    ...
    #criando dict para retornar o horario de inicio das aulas
    ...
    # criar dict para retornar a sala e abreviação do XML
    ...
    #faz a junção dos dados para trazer as combinações corretas entre as bases de dados
    log_sem_salas = {}
    log_sala_abrev={}
